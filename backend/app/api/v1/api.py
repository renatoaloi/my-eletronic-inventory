...
api_router.include_router(photos.public_router, prefix="/photos", tags=["photos"])
api_router.include_router(photos.router, prefix="/photos", tags=["photos"])
api_router.include_router(documents.public_router, prefix="/documents", tags=["documents"])
